...
class logmein {
    ...
    var $database_logon = 'Wakulima';       //Database NAME
    var $username_logon = 'root';       //Database USERNAME
    var $password_logon = '';       //Database PASSWORD
    //table fields
    var $user_table = 'farmers';          //Users table name
    var $user_column = 'f_mail';     //USERNAME column (value MUST be valid email)
    var $pass_column = 'f_pass';      //PASSWORD column
    var $user_level = 'f_role';      //(optional) userlevel column
    var $user_name = 'f_name';
    //encryption

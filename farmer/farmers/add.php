...
//    }
    ...
    if ($validation['valid'] == TRUE) {
        $sql = "INSERT INTO `farmers` ( `f_no` ,`f_id` , `f_name` ,`f_mail`,`f_pass`,`f_role`, `f_locallity` ,  `f_ac` ,  `f_phone`  ) VALUES(  '{$_POST['f_no']}' ,'{$_POST['f_id']}' , '{$_POST['f_name']}' ,'{$_POST['f_mail']}' ,'{$_POST['f_pass']}' ,'{$_POST['f_role']}' , '{$_POST['f_locallity']}' ,  '{$_POST['f_ac']}' ,  '{$_POST['f_phone']}'  ) ";
...
<?php echo $validation['id'] ?>
    ...
    <div class="control-group">
        <label class="control-label" for="f_mail"> Farmer email:</label >
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="email.." name='f_mail'/> 
        </div>
        <div class="control-group">
        <label class="control-label" for="f_pass"> Farmer password:</label >
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="pass.." name='f_pass'/> 
        </div>
        <div class="control-group">
        <label class="control-label" for="f_role"> Role:</label >
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="farmer" name='f_role'/> 
        </div>
    <div class="control-group">

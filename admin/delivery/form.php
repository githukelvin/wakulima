...
<form action='' method='POST' class="form-horizontal" name="delivery"> 
    ...
    <div class="control-group">
        <label class="control-label" for="r_deliverer"> Milk collected by:</label >
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="clerk-X.." name='r_deliverer' value='<?php echo isset($row)?stripslashes($row['r_deliverer']):'' ?>'/> 
        </div>
    </div>
    <div class="control-group">

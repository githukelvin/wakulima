...
<!-- Background image -->
        ...
        <div id="top" class="page-header">
            ...
            <div id="navigation" class="navbar pull-right">
                <h1 id="title" >Wakulima Dairy Milk Record System</h1>

                <ul class="nav navbar-inner">
                    <li><a href="<?php Page_Url() ?>">Home</a></li>
                    <li><a href="<?php Page_Url() ?>index.php">Farmers</a></li>
                    <li><a href="<?php Page_Url() ?>employees/index.php">Users</a></li>
                    ...
                    <li><a href="<?php Page_Url() ?>settings/index.php">Pricing</a></li>
                </ul>
            </div> <!--end navigation-->
        </div>
